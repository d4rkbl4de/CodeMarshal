...
class QuestionMetadata:
    ...
    def __init__(
        ...
        produces_output_type: str | None = None,
    ):
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"QuestionMetadata({self.question_type.name}, "
...
def get_question_metadata(question_type: QuestionType) -> QuestionMetadata | None:
...
def get_all_question_metadata() -> list[QuestionMetadata]:
    ...
    Constitutional: Returns copy to prevent modification.
    """
    return [QUESTION_REGISTRY[qt] for qt in QUESTION_ORDER if qt in QUESTION_REGISTRY]


def validate_question_flow(
    current: QuestionType | None, next_question: QuestionType
) -> bool:
