...
from typing import (
    ...
    DefaultDict, Counter, NamedTuple, FrozenSet
)
...
class PathNode:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'modification_time': (
                self.modification_time.isoformat()
                if self.modification_time else None
            ),
...
class StructureAnalysis:
    ...
    def get_flat_file_list(self) -> List[Dict[str, Any]]:
        ...
        def collect_files(node: Union[DirectoryTree, PathNode]) -> None:
    ...
    def get_directory_sizes(self) -> Dict[str, int]:
        ...
        def calculate_size(node: Union[DirectoryTree, PathNode]) -> int:
            if isinstance(node, DirectoryTree):
...
class StructureAnalyzer:
    ...
    def analyze(self) -> StructureAnalysis:
        ...
        total_files = sum(
            count for node_type, count in node_counts.items()
    ...
    def _calculate_size_distribution(
        ...
        """
        distribution: DefaultDict[str, List[int]] = collections.defaultdict(list)
...
def get_file_list_by_extension(
    ...
    return [
        ...
        if file.get('file_extension') == extension
    ]
