...
class ShutdownManager:
    ...
    def __init__(self, context: RuntimeContext) -> None:
        ...
        self._termination_record: Optional[TerminationRecord] = None
    ...
    def _signal_handler(self, signum: int, frame: Any) -> None:
        ...
        reason: TerminationReason = reason_mapping.get(signum, TerminationReason.SYSTEM_SIGNAL)
    ...
    def shutdown(
        ...
        if self._shutdown_initiated:
            ...
            return self._termination_record or self._create_minimal_record(reason, severity, error_message)
    ...
    def get_termination_record(self) -> Optional[TerminationRecord]:
...
def emergency_shutdown(
    message: str = "Emergency shutdown",
    exit_code: int = 1
) -> None:
    """
