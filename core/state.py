...
class InvestigationState:
    ...
    def is_transition_legal(
        cls, from_phase: InvestigationPhase, to_phase: InvestigationPhase
    ) -> bool:
    ...
    def transition_to(
        self, to_phase: InvestigationPhase, reason: str | None = None
    ) -> None:
        """
    ...
    def __str__(self) -> str:
        ...
        if transitions > 0:
            ...
            time_since = datetime.datetime.now(datetime.UTC) - last_transition.timestamp
            return (
