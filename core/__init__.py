...
if TYPE_CHECKING:
    ...
    from core.context import RuntimeContext, ExecutionMode, EnforcementLevel, ConstitutionalRule
    from core.state import InvestigationState, InvestigationPhase
    from core.engine import Engine, CoordinationRequest, CoordinationResult, HighLevelIntent
    from core.shutdown import TerminationReason, initialize_shutdown, shutdown, emergency_shutdown
