...
class TypographicRule:
    ...
    max_per_view: Optional[int] = None  # Cognitive load control
    requires_anchor: bool = False  # Must be anchored to specific observation
    prohibited_with: Set[TextRole] = field(default_factory=lambda: set())  # Explicit type
...
class TypographySystem:
    ...
    def __init__(self) -> None:
        ...
        self._current_primary: Optional[TextRole] = None
...
def validate_text_role(
    ...
    context_roles: Optional[List[TextRole]] = None
) -> List[str]:
    """
