...
class IconRule:
    ...
    required_context: str | None = None  # Required context to show icon
...
class IconSystem:
    ...
    def get_required_context(self, icon: SemanticIcon) -> str | None:
        """Get the required context for an icon, if any."""
        rule = self._rules[icon]
        return rule.required_context

    def validate_icons(
        self, icons: set[SemanticIcon], context: set[str] | None = None
    ) -> list[str]:
        """
    ...
    def resolve_conflict(self, icons: set[SemanticIcon]) -> SemanticIcon | None:
        """
...
def validate_icon_usage(
    ...
    context_icons: set[SemanticIcon] | None = None,
...
def icon_requires_context(icon: SemanticIcon) -> str | None:
