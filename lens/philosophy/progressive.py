...
class ProgressiveDisclosureRule:
    ...
    def get_current_gate(
        self, question_type: str, current_stage: DisclosureStage
    ) -> DisclosureGate | None:
        """
    ...
    def validate_disclosure(
        self, question_type: str, current_stage: DisclosureStage, content_type: str
    ) -> None:
        """
...
def validate_content_for_stage(
    question_type: str, current_stage: DisclosureStage, content: DisclosableContent
) -> bool:
    """
...
def get_available_content_types(
    question_type: str, current_stage: DisclosureStage
) -> frozenset[str]:
    """
