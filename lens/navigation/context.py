...
class NavigationContext:
    ...
    def __post_init__(self) -> None:
        ...
        if self.current_view is not None and not isinstance(
    ...
    def with_session_context(
        self, new_session_context: SessionContext
    ) -> "NavigationContext":
        """
    ...
    def is_same_focus(self, other: "NavigationContext") -> bool:
        ...
        return self.focus_type == other.focus_type and self.focus_id == other.focus_id
...
def create_initial_navigation_context(
    session_context: SessionContext, initial_focus_id: str = "system:welcome"
) -> NavigationContext:
    """
...
def validate_navigation_context_integrity(
    ...
    if ";" in context.focus_id or "," in context.focus_id:
        violations.append("Article 5 violation: focus_id contains multiple subjects")
