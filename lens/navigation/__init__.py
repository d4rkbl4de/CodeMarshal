...
def _validate_navigation_boundaries() -> None:
    ...
    local_functions = [
        ...
        if inspect.isfunction(obj) and obj.__module__ == __name__ and name != "_validate_navigation_boundaries"
    ]
    ...
    for name in dir(this_module):
        try:
            ...
            if module and module not in imported_modules:
                ...
                if module in cpython_internals or any(module.startswith(prefix) for prefix in cpython_internals):
                    continue
