...
from typing import Deque, Optional, Callable, Any, Dict, Tuple, List, Union
...
class Scheduler:
    ...
    def enqueue(self, task: Task) -> bool:
        ...
        with self._lock:
            ...
            if max_len is not None and len(queue) >= max_len:
                ...
                self._notify_status("queue_full", {
            ...
            logger.debug(f"Enqueued task {task.metadata.task_id} with priority {task.priority.name}")
            self._notify_status("task_enqueued", {
                "task_id": task.metadata.task_id,
                "priority": task.priority.name
            })
    ...
    def dequeue(self) -> Optional[Task]:
        ...
        """
        with self._lock:
            for priority in [TaskPriority.IMMEDIATE, TaskPriority.HIGH, 
    ...
    def _execute_task(self, task: Task) -> TaskResult:
        ...
        try:
            ...
            self._notify_status("task_completed", {
                "task_id": task_id,
            ...
            with self._lock:
                ...
                if result.duration_ms is not None:
                    ...
                    self._metrics["total_execution_time"] = current_time + result.duration_ms
            ...
            self._notify_status("task_failed", {
                "task_id": task_id,
                "error": error_msg
            })
    ...
    def run_all(self) -> None:
        ...
        self._notify_status("scheduler_completed", {
    ...
    def clear_pending(self, priority: Optional[TaskPriority] = None) -> int:
        ...
        with self._lock:
            ...
            if cleared > 0:
                self._notify_status("queue_cleared", {
                    "count": cleared,
...
_system_scheduler: Optional[Scheduler] = None
