...
class EditorIntegration:
    ...
    def map_anchors_to_locations(self, anchors: list[Anchor]) -> list[EditorLocation]:
        """
    ...
    def create_annotations_from_notes(
        self, notes: list[NotebookEntry], anchor_mapping: dict[str, EditorLocation]
    ...
    def generate_configuration(
        self, locations: list[EditorLocation], annotations: list[EditorAnnotation]
    ) -> dict[str, Any]:
        """
    ...
    def export_configuration(
        self, config: dict[str, Any], output_path: Path | None = None
    ) -> Path:
        """
    ...
    def _parse_anchor_location(self, anchor: Anchor) -> EditorLocation | None:
        """
            ...
            "tasks": [
                {
                    ...
                    "command": "echo",
                    "args": [
                        "Open the CodeMarshal configuration file to see observation locations"
                    ],
                    "problemMatcher": [],
                }
            ],
        ...
        config = {
            ...
            "observations": {
                ...
                "formats": {
                    ...
                    "with_lines": [
                        loc.to_neovim_position() for loc in locations if loc.line
                    ],
                },
            },
            "annotations": {
...
def create_editor_integration(editor_type: EditorType | str) -> EditorIntegration:
    """
