...
def check_directory_integrity(
    ...
    hash_manifest: Optional[Dict[str, str]] = None
...
class CorruptionDetector:
    ...
    def check_file(
        ...
        min_size: int = 1,
        is_json: bool = False,
        json_required_fields: Optional[set[str]] = None,
        is_binary: bool = False,
        binary_magic: Optional[bytes] = None,
    ...
    def check_directory(
        ...
        Returns:
            List of corruption evidence found
        """
        evidence = check_directory_integrity(
            dir_path, expected_files, hash_manifest
        )
        self._detected_corruption.extend(evidence)
        return evidence
    ...
    def mark_all_corruption(self) -> List[Path]:
        ...
        for evidence in self._detected_corruption:
            try:
                marker_path = CorruptionMarker.create_marker(
...
def detect_corruption(data: bytes, context_type: str) -> Optional[CorruptionState]:
    """
