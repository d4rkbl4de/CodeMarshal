...
class SystemDefaults:
    ...
    CACHE_SUBDIRS: frozenset[str] = field(
    ...
    WITNESS_DEFAULTS: dict[str, Any] = field(
    ...
    INVESTIGATE_DEFAULTS: dict[str, Any] = field(
        default_factory=lambda: {
            "depth": 3,
    ...
    OBSERVATION_DEFAULTS: dict[str, Any] = field(
        default_factory=lambda: {
            "enabled_eyes": [
                "file_sight",
                "import_sight",
    ...
    PRESET_CONSTITUTIONAL: dict[str, Any] = field(
        default_factory=lambda: {
            "enabled_eyes": [
                "file_sight",
                "import_sight",
    ...
    PRESET_QUICK: dict[str, Any] = field(
        default_factory=lambda: {
            "enabled_eyes": [
                "file_sight",
                "import_sight",
    ...
    PATTERNS_DEFAULTS: dict[str, Any] = field(
        default_factory=lambda: {
            "window_size": 10,
    ...
    EXPORT_DEFAULTS: dict[str, Any] = field(
        default_factory=lambda: {
    ...
    NOTEBOOK_DEFAULTS: dict[str, Any] = field(
        default_factory=lambda: {
    ...
    SESSION_DEFAULTS: dict[str, Any] = field(
        default_factory=lambda: {
    ...
    INTEGRITY_DEFAULTS: dict[str, Any] = field(
        default_factory=lambda: {
    ...
    PERFORMANCE_DEFAULTS: dict[str, Any] = field(
        default_factory=lambda: {
    ...
    DISPLAY_DEFAULTS: dict[str, Any] = field(
        default_factory=lambda: {
            "color": True,
            "progress_bars": True,
    ...
    CONSTITUTIONAL_DEFAULTS: dict[str, Any] = field(
        default_factory=lambda: {
    ...
    ERROR_DEFAULTS: dict[str, Any] = field(
        default_factory=lambda: {
    ...
    VALIDATION_DEFAULTS: dict[str, Any] = field(
        default_factory=lambda: {
            "validate_paths": True,
    ...
    COMMAND_DEFAULTS: dict[CommandType, dict[str, Any]] = field(
        default_factory=lambda: {
            CommandType.WITNESS: {
    ...
    FILE_TYPE_DEFAULTS: dict[str, list[str]] = field(
        default_factory=lambda: {
    ...
    ENCODING_DEFAULTS: dict[str, Any] = field(
        default_factory=lambda: {
    ...
    HASHING_DEFAULTS: dict[str, Any] = field(
        default_factory=lambda: {
            "algorithm": "sha256",
