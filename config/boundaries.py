...
class BoundaryConfigLoader:
    ...
    def _parse_boundaries(self, boundaries_data: List[Dict[str, Any]]) -> List[BoundaryDefinition]:
    ...
    def _parse_single_boundary(self, data: Dict[str, Any]) -> BoundaryDefinition:
        ...
        boundary_type = self._type_map.get(boundary_type_str.lower(), BoundaryType.CUSTOM)
...
def get_agent_nexus_config(project_root: Optional[Path] = None) -> Optional[BoundaryConfig]:
    """
