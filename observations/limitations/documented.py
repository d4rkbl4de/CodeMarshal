...
class LimitationDoc:
    ...
    mitigation_notes: Optional[str] = None  # How humans can work around it
    ...
    def to_markdown(self) -> str:
        ...
        lines = [
            ...
            f"",
            f"### Implications for Interpretation",
...
def get_doc_for_limitation(limitation_id: str) -> Optional[LimitationDoc]:
