...
from typing import (
    Any, Dict, List, Optional, Tuple, Union, Generic, TypeVar,
...
class ErrorContext:
    ...
    def __post_init__(self) -> None:
        ...
        if isinstance(self.additional_info, dict):
            ...
            object.__setattr__(self, "additional_info", _make_immutable(self.additional_info))
...
class Provenance:
    ...
    input_hash: Optional[str] = None  # Hash of input for reproducibility
    environment_fingerprint: Optional[str] = None  # Hash of relevant environment
...
class ObservationResult(Generic[T]):
    ...
    def with_additional_context(
        ...
        **kwargs: Any
        ...
        allowed_updates = {'provenance', 'errors', 'warnings', 
                          'memory_usage_bytes', 'cpu_time_ms'}
    ...
    def validate(self) -> bool:
        ...
        try:
            ...
            stdlib_modules = {
                ...
                'hashlib', 'json', 're', 'collections', 'itertools', 'functools',
                'abc', 'inspect', 'enum', 'math', 'statistics', 'random',
                'string', 'textwrap', 'types', 'warnings', 'contextlib'
            }
    ...
    def _observe_impl(self, target: Path) -> ObservationResult:
        ...
        try:
            ...
            observation_data = {
                ...
                "access_time": datetime.fromtimestamp(stats.st_atime, tz=timezone.utc).isoformat(),
            }
