...
class WriteInterceptor:
    ...
    def get_patches(self) -> dict[str, Any]:
        ...
        def monitored_write_text(
            self_path: Path, data: str, *args: Any, **kwargs: Any
        ) -> None:
...
class TestObservationPurity:
    ...
    def test_readonly_file_handling(self) -> None:
        ...
        with patch.dict("builtins.__dict__", patches):
            ...
            chmod_attempts = [
                call
                for call in self.write_interceptor.write_calls
...
def test_article_1_compliance() -> None:
    ...
    try:
        ...
        with patch.dict("builtins.__dict__", patches):
            ...
            if interceptor.write_calls:
                pytest.fail(
                    "Article 1 violation: Writes during observation:\n"
            ...
            for obs in observations:
                ...
                for word in inference_words:
                    if word in content:
                        pytest.fail(
                            f"Article 1 violation: Inference word '{word}' in observation"
                        )
