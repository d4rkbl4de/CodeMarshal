...
class BoundaryMatcher:
    ...
    def find_boundary(self, path: Path) -> Optional[Boundary]:
        """
...
class BoundaryViolationChecker:
    ...
    def check_boundary_violation(self, 
                               source_path: Path, 
                               target_path: Path) -> Optional[Violation]:
        """
        ...
        if (source_boundary.allowed_imports and 
            target_boundary.name not in source_boundary.allowed_imports):
            return Violation(
    ...
    def check_import_statement(self,
                           source_path: Path,
                           import_statement: Dict[str, Any]) -> List[Violation]:
        """
    ...
    def check_file_imports(self,
                          source_path: Path,
                          import_statements: List[Dict[str, Any]]) -> List[Violation]:
        """
    ...
    def check_directory_imports(self,
                               directory_path: Path,
                               imports_by_file: Dict[Path, List[Dict[str, Any]]]) -> Dict[str, List[Violation]]:
        """
...
def create_agent_nexus_boundaries() -> List[Boundary]:
    ...
    return [
        ...
        Boundary(
            ...
            prohibited_imports=set(["lobes", "infrastructure", "common"]),
        ...
        Boundary(
            ...
            allowed_imports=set(["core"]),  # Can only import from core
            prohibited_imports=set(["lobes"]),
        ...
        Boundary(
            ...
            allowed_imports=set(["core", "infrastructure"]),
            prohibited_imports=set(["lobes"]),
        ...
        Boundary(
            ...
            allowed_imports=set(["core", "infrastructure", "common"]),
            prohibited_imports=set(["insightmate", "dataminer", "analyzer"]),
        ...
        Boundary(
            ...
            allowed_imports=set(["core", "infrastructure", "common"]),
            prohibited_imports=set(["chatbuddy", "dataminer", "analyzer"]),
        ...
        Boundary(
            ...
            allowed_imports=set(["core", "infrastructure", "common"]),
            prohibited_imports=set(["chatbuddy", "insightmate", "analyzer"]),
        ...
        Boundary(
            ...
            allowed_imports=set(["core", "infrastructure", "common"]),
            prohibited_imports=set(["chatbuddy", "insightmate", "dataminer"]),
